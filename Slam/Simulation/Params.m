...
sen.cnoise = 1e-2.*[1,0.1*(pi/180)];    % Camera Noise [m^2,rad^2]  
sen.gnoise = 1e-2.*[10,10,10];          % GPS Noise [m^2];
sen.inoise = 1e-2*(pi/180).*[10,1,1];   % IMU Noise [rad^2]; 
sen.vnoise = 1e-2.*ones(1,6);           % Deriv Noise [m^2/s^2,rad^2/s^2]
